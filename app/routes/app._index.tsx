        ...
        <s-section heading="Workflows">
          ...
          <s-stack direction="block" gap="base">
            ...
            <s-box padding="base" borderWidth="base" borderRadius="base" background="subdued">
              ...
              <s-text tone="subdued" as="p" style={{ margin: "0 0 0.85rem", lineHeight: 1.5 }}>
                Generate descriptions and SEO title and meta from a product detail page.
              </s-text>
              <EmbeddedNavLink
                hrefPathname="/app/seo-writer"
                style={{
                  display: "inline-flex",
                  alignItems: "center",
                  justifyContent: "center",
            ...
            <s-box padding="base" borderWidth="base" borderRadius="base" background="subdued">
              ...
              <s-text tone="subdued" as="p" style={{ margin: "0 0 0.85rem", lineHeight: 1.5 }}>
                Create AI product photos with preview or automatic attach to the product.
              </s-text>
              <EmbeddedNavLink
                hrefPathname="/app/image-generator"
                style={{
                  display: "inline-flex",
                  alignItems: "center",
                  justifyContent: "center",
